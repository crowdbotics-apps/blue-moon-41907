"""
Django settings for blue_moon_41907 project.
...
ROOT_URLCONF = 'blue_moon_41907.urls'
...
WSGI_APPLICATION = 'blue_moon_41907.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "blue_moon_41907 API",
    "DESCRIPTION": "API documentation for blue_moon_41907 App",
    "VERSION": "v1",
}
